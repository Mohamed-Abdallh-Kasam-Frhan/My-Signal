...
class SignCard extends StatefulWidget {
  ...
  const SignCard({
    super.key,
    required this.sign,
    required this.category, // قيمة افتراضية
  });
...
class _SignCardState extends State<SignCard> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        context.push('/home/signs/${widget.category?.id}/details/${widget.sign.id}?title=${widget.sign.title}'); // نمرر الـ id والعنوان في الرابط
      },
      child: Container(
